...
data augmentation\footnote{\textcolor{blue}{
...
illustrate the potential gain using template-based data augmentation.  Training
...
Accuracy, in terms of Dice overlap, achieved with augmentation was
...
the evaluation data used in [@Tustison:2011aa].   The resulting probability iamges were converted into a single segmentation
