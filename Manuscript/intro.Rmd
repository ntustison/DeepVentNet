...
common use case scenarios in which \textcolor{blue}{proton images are used to identify regions of 
interest in corresponding ventilation images} [@Tustison:2011aa;@Kirby:2012aa;@He:2014aa], 
\textcolor{blue}{which typically contain no discernible boundaries for anatomic structures.}
