...
These findings, along with related research, has motivated the development of multiple automated (and semi-automated) 
...
recent developments in maching learning (specifically "deep learning" 
...
to adopting deep learning techniques is the large data requirements for
...
an approach tailored to commonly encountered medical imaging scenarios.
...
transformation of each image to every other image thus potentially 
...
Advanced Normalization Tools (ANTs) package [@antsr] and its  R package
(i.e., ANTsR) [@antsr].  This permits the public distribution of
...
data and/or use the models to initialize
their own model development tailored to their studies. 

In the work described below, we first provide the acquisition protocols for both
the helium and ventilation images followed by a discussion of the analysis 
