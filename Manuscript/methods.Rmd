...
(repetition time [TR]:1.80 ms, echo time [TE] 0.78 ms, flip angle 10􏰀, bandwidth per 
...
(Need a diagram of the workflow)
...
\caption{Example side-by-side image comparison showing the effects of preprocessing on the proton MRI. (a) 
