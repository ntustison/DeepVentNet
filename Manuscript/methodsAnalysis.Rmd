...
\textcolor{black}{Unlike other methods that rely solely on intensity distributions, thereby 
...
characterized  \textcolor{black}{by an optional dropout layer in between two convolutional layers}.  This 
...
shape variation \textcolor{black}{within the typical range exhibited by the} population under study.
...
\end{align}
\textcolor{black}{Note that each $S$ comprises all channel images and corresponding segmentation images.}
...
\caption{
\textcolor{black}{Template-based data augmentation for the proton (left) and
...
variety of applications \textcolor{black}{have} motivated adoption of such techniques.
Basic image operations such as classification, object identification, 
segmentation, as well as more focused techniques, \textcolor{black}{such as predictive image registration} [@Yang:2017aa],
...
our GitHub \textcolor{black}{repository} [@deepventnet]), create the model, designate model parameters, and initialize 
the batch generator.  
...
resources.  \textcolor{black}{Transforms derived from the template-building process described
...
\textcolor{black}{The 3-D U-net structural model and 2-D U-net functional model that were created,
